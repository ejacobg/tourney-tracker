...
// tournament will create a tourney_tracker.Tournament object using the data from the response.
...
// entrants will return a []Entrant using the data from the response.
